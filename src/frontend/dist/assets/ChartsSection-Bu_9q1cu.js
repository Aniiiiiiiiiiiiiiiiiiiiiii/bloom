import { c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, a as clsx, R as React, i as invariant, b as groups, j as jsxRuntimeExports, m as motion } from "./index-Biqxei8G.js";
import { A as AnimatePresence, l as lesserafimSongs, c as cortisSongs, b as btsSongs, i as illitSongs } from "./lesserafim-data-CY6J4rJk.js";
...
function fmtNum(n2) {
  ...
  if (n2 >= 1e3) return `${(n2 / 1e3).toFixed(0)}K`;
  return String(n2);
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "oklch(0.85 0 0)" }, children: [
                p2.name,
                ":",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#fff" }, children: fmtNum(p2.value) })
              ] })
            ]
          },
          p2.name
...
function TopSongsChart({ songs, primaryColor }) {
  const [platform, setPlatform] = reactExports.useState("spotify");
  const sorted = reactExports.useMemo(() => {
    const s2 = [...songs];
    if (platform === "spotify") s2.sort((a2, b2) => b2.streams - a2.streams);
    else if (platform === "youtube")
      s2.sort((a2, b2) => b2.youtubeViews - a2.youtubeViews);
    else
      s2.sort((a2, b2) => {
        const ra = a2.itunesRank ?? 9999;
        const rb = b2.itunesRank ?? 9999;
        return ra - rb;
      });
    return s2.slice(0, 10);
  }, [songs, platform]);
  const topSong = sorted[0];
  const metricLabel = platform === "spotify" ? "streams" : platform === "youtube" ? "views" : "chart rank";
  const topValue = platform === "spotify" ? topSong.streams : platform === "youtube" ? topSong.youtubeViews : null;
  const barData = sorted.map((s2) => ({
    name: s2.title,
    value: platform === "spotify" ? s2.streams : platform === "youtube" ? s2.youtubeViews : s2.itunesRank !== null ? Math.max(0, 100 - s2.itunesRank * 3) : 0,
    rank: platform === "itunes" ? s2.itunesRank : null
  }));
  const PLATFORM_TABS = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: PLATFORM_TABS.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => setPlatform(t2.id),
            "data-ocid": `charts.platform_tab.${t2.id}`,
            style: {
              background: platform === t2.id ? primaryColor : "oklch(0.18 0 0)",
              color: platform === t2.id ? "oklch(0.1 0 0)" : "oklch(0.65 0 0)",
              border: `1px solid ${platform === t2.id ? primaryColor : "oklch(0.28 0 0)"}`,
              borderRadius: "999px",
              padding: "4px 16px",
              fontSize: "12px",
              fontWeight: 600,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mb-4", style: { color: "oklch(0.62 0 0)" }, children: [
      "🔥",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: primaryColor, fontWeight: 700 }, children: [
        "‘",
        topSong.title,
        "’"
      ] }),
      ...
      "leads with",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.9 0 0)" }, children: topValue !== null ? fmtNum(topValue) : `#${topSong.itunesRank ?? "?"}` }),
      " ",
      metricLabel
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-4", children: sorted.slice(0, 5).map((s2) => {
      const change = rankChange(s2.itunesRank);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.75 0 0)" }, children: s2.title }),
...
function TrendsChart({ songs, primaryColor }) {
  const top5 = reactExports.useMemo(
    () => [...songs].sort((a2, b2) => b2.streams - a2.streams).slice(0, 5),
    [songs]
  );
  const lineData = DAYS.map((day, i) => {
    const obj = { day };
    for (const s2 of top5) {
      obj[s2.title] = s2.weeklyTrend[i] ?? 0;
    }
    return obj;
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-4", style: { color: "oklch(0.62 0 0)" }, children: "📈 Weekly streaming trend for top 5 songs — last 7 days" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      LineChart,
      {
        ...
        children: [
          ...
          top5.map((s2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Line,
            {
              type: "monotone",
              dataKey: s2.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mt-5", children: top5.map((s2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "oklch(0.68 0 0)" }, children: s2.title })
    ] }, s2.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-4", style: { color: "oklch(0.62 0 0)" }, children: [
      "🔥",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: primaryColor, fontWeight: 700 }, children: [
        "‘",
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { style: { color: "oklch(0.9 0 0)" }, children: [
        Math.max(...top5[0].weeklyTrend),
        "M"
      ] }),
      " ",
      "daily streams"
...
function PlatformBreakdown({ songs, primaryColor }) {
  const totals = reactExports.useMemo(() => {
    const spotify = songs.reduce((acc, s2) => acc + s2.streams, 0);
    const youtube = songs.reduce((acc, s2) => acc + s2.youtubeViews, 0);
    const itunes = Math.round(spotify * 0.08);
    const apple = Math.round(spotify * 0.12);
    const total2 = spotify + youtube + itunes + apple;
    return [
      {
        name: "Spotify",
        value: spotify,
        pct: Math.round(spotify / total2 * 100)
      },
      {
        name: "YouTube",
        value: youtube,
        pct: Math.round(youtube / total2 * 100)
      },
      {
        name: "Apple Music",
        value: apple,
        pct: Math.round(apple / total2 * 100)
      },
      {
        name: "iTunes",
        value: itunes,
        pct: Math.round(itunes / total2 * 100)
      }
    ];
  }, [songs]);
  const total = totals.reduce((a2, d2) => a2 + d2.value, 0);
  ...
  const renderLabel = ({
    ...
    const x2 = cx + r * Math.cos(-midAngle * RADIAN2);
    const y2 = cy + r * Math.sin(-midAngle * RADIAN2);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "text",
      {
        x: x2,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-4", style: { color: "oklch(0.62 0 0)" }, children: "🎵 Stream distribution across major platforms" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: 260, height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Pie,
                {
                  data: totals,
                  ...
                  label: renderLabel,
                  labelLine: false,
                  children: totals.map((d2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: PLATFORM_COLORS[i], stroke: "none" }, d2.name))
                }
              ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { top: 0 },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 10, color: "oklch(0.55 0 0)" }, children: "Total Streams" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 w-full space-y-3", children: [
        totals.map((d2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.75 0 0)" }, children: d2.name })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "oklch(0.8 0 0)", fontWeight: 600 }, children: [
              fmtNum(d2.value),
              " (",
              d2.pct,
              "%)"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs pt-2", style: { color: "oklch(0.62 0 0)" }, children: [
          "🔥",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: primaryColor, fontWeight: 700 }, children: topPlatform.name }),
          " ",
          "leads with",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { style: { color: "oklch(0.9 0 0)" }, children: [
...
function ChartsSection({ groupId }) {
  const [activeTab, setActiveTab] = reactExports.useState("top-songs");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "charts.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: CHART_TABS.map((tab) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginRight: 5 }, children: tab.emoji }),
                tab.label
              ]
            },
            tab.id
        ...
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h2",
              {
                ...
                children: [
                  ...
                  activeTab === "platforms" && `${group.name} — Platform Breakdown`
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-1", style: { color: "oklch(0.5 0 0)" }, children: [
              activeTab === "top-songs" && "Sorted by streams across major platforms. Click a platform filter to switch.",
              activeTab === "trends" && "Daily streaming data for the top 5 songs over the past 7 days.",
              activeTab === "platforms" && "Total stream count distribution across Spotify, YouTube, Apple Music & iTunes."
            ] })
          ] }),
          activeTab === "top-songs" && /* @__PURE__ */ jsxRuntimeExports.jsx(TopSongsChart, { songs, primaryColor: primary }),
          activeTab === "trends" && /* @__PURE__ */ jsxRuntimeExports.jsx(TrendsChart, { songs, primaryColor: primary }),
          activeTab === "platforms" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            PlatformBreakdown,
            {
              songs,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "Last updated: April 20, 2026"
            }
          )
        ]
      },
